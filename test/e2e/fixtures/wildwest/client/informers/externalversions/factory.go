...
import (
	...
	wildwestinformers "github.com/kcp-dev/kcp/test/e2e/fixtures/wildwest/client/informers/externalversions/wildwest"
)
...
func (f *sharedInformerFactory) Wildwest() wildwestinformers.ClusterInterface {
...
func (f *sharedScopedInformerFactory) Wildwest() wildwestinformers.Interface {
	return wildwestinformers.NewScoped(f, f.namespace, f.tweakListOptions)
}
