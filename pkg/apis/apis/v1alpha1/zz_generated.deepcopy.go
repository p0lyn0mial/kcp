...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClusterExportReference) DeepCopyInto(out *ClusterExportReference) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterExportReference.
func (in *ClusterExportReference) DeepCopy() *ClusterExportReference {
	if in == nil {
		return nil
	}
	out := new(ClusterExportReference)
	in.DeepCopyInto(out)
	return out
}
