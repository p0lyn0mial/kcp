...
type TenancyV1beta1ClusterInterface interface {
	TenancyV1beta1ClusterScoper
...
func (c *TenancyV1beta1ClusterClient) Cluster(path logicalcluster.Path) tenancyv1beta1.TenancyV1beta1Interface {
...
// NewForConfig creates a new TenancyV1beta1ClusterClient for the given config.
// NewForConfig is equivalent to NewForConfigAndClient(c, httpClient),
// where httpClient was generated with rest.HTTPClientFor(c).
func NewForConfig(c *rest.Config) (*TenancyV1beta1ClusterClient, error) {
...
// NewForConfigAndClient creates a new TenancyV1beta1ClusterClient for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*TenancyV1beta1ClusterClient, error) {
...
// NewForConfigOrDie creates a new TenancyV1beta1ClusterClient for the given config and
// panics if there is an error in the config.
func NewForConfigOrDie(c *rest.Config) *TenancyV1beta1ClusterClient {
