...
var pathAnnotationResources = sets.NewString(
	workloadv1alpha1.Resource("locations").String(),
	apisv1alpha1.Resource("clusterworkspacetypes").String(),
)
...
func (p *pathAnnotationPlugin) Validate(ctx context.Context, a admission.Attributes, _ admission.ObjectInterfaces) error {
	...
	if (pathAnnotationResources.Has(a.GetResource().GroupResource().String()) && !found) || value != path.String() {
