...
func TestValidate(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			expectedErrors: []string{".spec.reference.cluster is required"},
		},
		{
			...
			expectedErrors: []string{"spec.reference.cluster.identifier: Required value"},
		},
		{
			...
			expectedErrors: []string{"spec.reference.cluster.exportName: Required value"},
		},
		{
