...
func (o *apiBindingAdmission) Admit(ctx context.Context, a admission.Attributes, _ admission.ObjectInterfaces) error {
	...
	if apiBinding.Spec.Reference.Cluster == nil {
		...
		apiBinding.Labels[apisv1alpha1.InternalAPIBindingExportLabelKey] = permissionclaims.ToAPIBindingExportLabelValue(
			apiBinding.Spec.Reference.Cluster.Identifier,
...
func (o *apiBindingAdmission) Validate(ctx context.Context, a admission.Attributes, _ admission.ObjectInterfaces) error {
	...
	if apiBinding.Spec.Reference.Cluster == nil {
		return admission.NewForbidden(a, fmt.Errorf(".spec.reference.cluster is required"))
	}
	...
	// Access check
	if err := o.checkAPIExportAccess(ctx, a.GetUserInfo(), apiBinding.Spec.Reference.Cluster.Identifier.Path(), apiBinding.Spec.Reference.Cluster.ExportName); err != nil {
		action := "create"
